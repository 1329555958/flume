 ...
 * under the License.
 */
package com.vf.flume.sink.elasticsearch2.client;
...
import com.vf.flume.sink.elasticsearch2.ElasticSearchEventSerializer;
import com.vf.flume.sink.elasticsearch2.ElasticSearchIndexRequestBuilderFactory;
import com.vf.flume.sink.elasticsearch2.ElasticSearchSinkConstants;
import com.vf.flume.sink.elasticsearch2.IndexNameBuilder;
...
public class ElasticSearchTransportClient implements ElasticSearchClient {
    ...
    Map<String,Integer> map = new java.util.concurrent.ConcurrentHashMap<String,Integer>();
    @Override
    public void addEvent(Event event, IndexNameBuilder indexNameBuilder,
        ...
        String key = indexNameBuilder.getIndexName(event)+"_"+indexType ;
    ...
    public void execute() throws Exception {
        try {
        	...
        	map = new java.util.concurrent.ConcurrentHashMap<String,Integer>();
        	
        	
//        	System.out.println("              execute size == "+bulkRequestBuilder.numberOfActions()); ; 
            ...
            bulkRequestBuilder = client.prepareBulk();
//            System.out.println("           init   execute size == "+bulkRequestBuilder.numberOfActions()); ;
        }
    }
